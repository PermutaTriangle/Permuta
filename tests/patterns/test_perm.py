...
def test_depth():
    ...
    Perm((0, 1, 2, 3, 4, 5)).depth() == 0
    Perm((0, 1, 2, 3, 5, 4)).depth() == 1
    Perm((0, 1, 2, 4, 3, 5)).depth() == 1
    Perm((0, 1, 2, 4, 5, 3)).depth() == 2
    Perm((0, 1, 2, 5, 3, 4)).depth() == 2
    Perm((0, 1, 2, 5, 4, 3)).depth() == 2
    Perm((0, 1, 3, 2, 4, 5)).depth() == 1
    Perm((0, 1, 3, 2, 5, 4)).depth() == 2
    Perm((0, 1, 3, 4, 2, 5)).depth() == 2
    Perm((0, 1, 3, 4, 5, 2)).depth() == 3
    Perm((0, 1, 3, 5, 2, 4)).depth() == 3
    Perm((0, 1, 3, 5, 4, 2)).depth() == 3
    Perm((0, 1, 4, 2, 3, 5)).depth() == 2
    Perm((0, 1, 4, 2, 5, 3)).depth() == 3
    Perm((0, 1, 4, 3, 2, 5)).depth() == 2
    Perm((0, 1, 4, 3, 5, 2)).depth() == 3
    Perm((0, 1, 4, 5, 2, 3)).depth() == 4
    Perm((0, 1, 4, 5, 3, 2)).depth() == 4
    Perm((0, 1, 5, 2, 3, 4)).depth() == 3
    Perm((0, 1, 5, 2, 4, 3)).depth() == 3
    Perm((0, 1, 5, 3, 2, 4)).depth() == 3
    Perm((0, 1, 5, 3, 4, 2)).depth() == 3
    Perm((0, 1, 5, 4, 2, 3)).depth() == 4
    Perm((0, 1, 5, 4, 3, 2)).depth() == 4
    Perm((0, 2, 1, 3, 4, 5)).depth() == 1
    Perm((0, 2, 1, 3, 5, 4)).depth() == 2
    Perm((0, 2, 1, 4, 3, 5)).depth() == 2
    Perm((0, 2, 1, 4, 5, 3)).depth() == 3
    Perm((0, 2, 1, 5, 3, 4)).depth() == 3
    Perm((0, 2, 1, 5, 4, 3)).depth() == 3
    Perm((0, 2, 3, 1, 4, 5)).depth() == 2
    Perm((0, 2, 3, 1, 5, 4)).depth() == 3
    Perm((0, 2, 3, 4, 1, 5)).depth() == 3
    Perm((0, 2, 3, 4, 5, 1)).depth() == 4
    Perm((0, 2, 3, 5, 1, 4)).depth() == 4
    Perm((0, 2, 3, 5, 4, 1)).depth() == 4
    Perm((0, 2, 4, 1, 3, 5)).depth() == 3
    Perm((0, 2, 4, 1, 5, 3)).depth() == 4
    Perm((0, 2, 4, 3, 1, 5)).depth() == 3
    Perm((0, 2, 4, 3, 5, 1)).depth() == 4
    Perm((0, 2, 4, 5, 1, 3)).depth() == 5
    Perm((0, 2, 4, 5, 3, 1)).depth() == 5
    Perm((0, 2, 5, 1, 3, 4)).depth() == 4
    Perm((0, 2, 5, 1, 4, 3)).depth() == 4
    Perm((0, 2, 5, 3, 1, 4)).depth() == 4
    Perm((0, 2, 5, 3, 4, 1)).depth() == 4
    Perm((0, 2, 5, 4, 1, 3)).depth() == 5
    Perm((0, 2, 5, 4, 3, 1)).depth() == 5
    Perm((0, 3, 1, 2, 4, 5)).depth() == 2
    Perm((0, 3, 1, 2, 5, 4)).depth() == 3
    Perm((0, 3, 1, 4, 2, 5)).depth() == 3
    Perm((0, 3, 1, 4, 5, 2)).depth() == 4
    Perm((0, 3, 1, 5, 2, 4)).depth() == 4
    Perm((0, 3, 1, 5, 4, 2)).depth() == 4
    Perm((0, 3, 2, 1, 4, 5)).depth() == 2
    Perm((0, 3, 2, 1, 5, 4)).depth() == 3
    Perm((0, 3, 2, 4, 1, 5)).depth() == 3
    Perm((0, 3, 2, 4, 5, 1)).depth() == 4
    Perm((0, 3, 2, 5, 1, 4)).depth() == 4
    Perm((0, 3, 2, 5, 4, 1)).depth() == 4
    Perm((0, 3, 4, 1, 2, 5)).depth() == 4
    Perm((0, 3, 4, 1, 5, 2)).depth() == 5
    Perm((0, 3, 4, 2, 1, 5)).depth() == 4
    Perm((0, 3, 4, 2, 5, 1)).depth() == 5
    Perm((0, 3, 4, 5, 1, 2)).depth() == 6
    Perm((0, 3, 4, 5, 2, 1)).depth() == 6
    Perm((0, 3, 5, 1, 2, 4)).depth() == 5
    Perm((0, 3, 5, 1, 4, 2)).depth() == 5
    Perm((0, 3, 5, 2, 1, 4)).depth() == 5
    Perm((0, 3, 5, 2, 4, 1)).depth() == 5
    Perm((0, 3, 5, 4, 1, 2)).depth() == 6
    Perm((0, 3, 5, 4, 2, 1)).depth() == 6
    Perm((0, 4, 1, 2, 3, 5)).depth() == 3
    Perm((0, 4, 1, 2, 5, 3)).depth() == 4
    Perm((0, 4, 1, 3, 2, 5)).depth() == 3
    Perm((0, 4, 1, 3, 5, 2)).depth() == 4
    Perm((0, 4, 1, 5, 2, 3)).depth() == 5
    Perm((0, 4, 1, 5, 3, 2)).depth() == 5
    Perm((0, 4, 2, 1, 3, 5)).depth() == 3
    Perm((0, 4, 2, 1, 5, 3)).depth() == 4
    Perm((0, 4, 2, 3, 1, 5)).depth() == 3
    Perm((0, 4, 2, 3, 5, 1)).depth() == 4
    Perm((0, 4, 2, 5, 1, 3)).depth() == 5
    Perm((0, 4, 2, 5, 3, 1)).depth() == 5
    Perm((0, 4, 3, 1, 2, 5)).depth() == 4
    Perm((0, 4, 3, 1, 5, 2)).depth() == 5
    Perm((0, 4, 3, 2, 1, 5)).depth() == 4
    Perm((0, 4, 3, 2, 5, 1)).depth() == 5
    Perm((0, 4, 3, 5, 1, 2)).depth() == 6
    Perm((0, 4, 3, 5, 2, 1)).depth() == 6
    Perm((0, 4, 5, 1, 2, 3)).depth() == 6
    Perm((0, 4, 5, 1, 3, 2)).depth() == 6
    Perm((0, 4, 5, 2, 1, 3)).depth() == 6
    Perm((0, 4, 5, 2, 3, 1)).depth() == 6
    Perm((0, 4, 5, 3, 1, 2)).depth() == 6
    Perm((0, 4, 5, 3, 2, 1)).depth() == 6
    Perm((0, 5, 1, 2, 3, 4)).depth() == 4
    Perm((0, 5, 1, 2, 4, 3)).depth() == 4
    Perm((0, 5, 1, 3, 2, 4)).depth() == 4
    Perm((0, 5, 1, 3, 4, 2)).depth() == 4
    Perm((0, 5, 1, 4, 2, 3)).depth() == 5
    Perm((0, 5, 1, 4, 3, 2)).depth() == 5
    Perm((0, 5, 2, 1, 3, 4)).depth() == 4
    Perm((0, 5, 2, 1, 4, 3)).depth() == 4
    Perm((0, 5, 2, 3, 1, 4)).depth() == 4
    Perm((0, 5, 2, 3, 4, 1)).depth() == 4
    Perm((0, 5, 2, 4, 1, 3)).depth() == 5
    Perm((0, 5, 2, 4, 3, 1)).depth() == 5
    Perm((0, 5, 3, 1, 2, 4)).depth() == 5
    Perm((0, 5, 3, 1, 4, 2)).depth() == 5
    Perm((0, 5, 3, 2, 1, 4)).depth() == 5
    Perm((0, 5, 3, 2, 4, 1)).depth() == 5
    Perm((0, 5, 3, 4, 1, 2)).depth() == 6
    Perm((0, 5, 3, 4, 2, 1)).depth() == 6
    Perm((0, 5, 4, 1, 2, 3)).depth() == 6
    Perm((0, 5, 4, 1, 3, 2)).depth() == 6
    Perm((0, 5, 4, 2, 1, 3)).depth() == 6
    Perm((0, 5, 4, 2, 3, 1)).depth() == 6
    Perm((0, 5, 4, 3, 1, 2)).depth() == 6
    Perm((0, 5, 4, 3, 2, 1)).depth() == 6
    Perm((1, 0, 2, 3, 4, 5)).depth() == 1
    Perm((1, 0, 2, 3, 5, 4)).depth() == 2
    Perm((1, 0, 2, 4, 3, 5)).depth() == 2
    Perm((1, 0, 2, 4, 5, 3)).depth() == 3
    Perm((1, 0, 2, 5, 3, 4)).depth() == 3
    Perm((1, 0, 2, 5, 4, 3)).depth() == 3
    Perm((1, 0, 3, 2, 4, 5)).depth() == 2
    Perm((1, 0, 3, 2, 5, 4)).depth() == 3
    Perm((1, 0, 3, 4, 2, 5)).depth() == 3
    Perm((1, 0, 3, 4, 5, 2)).depth() == 4
    Perm((1, 0, 3, 5, 2, 4)).depth() == 4
    Perm((1, 0, 3, 5, 4, 2)).depth() == 4
    Perm((1, 0, 4, 2, 3, 5)).depth() == 3
    Perm((1, 0, 4, 2, 5, 3)).depth() == 4
    Perm((1, 0, 4, 3, 2, 5)).depth() == 3
    Perm((1, 0, 4, 3, 5, 2)).depth() == 4
    Perm((1, 0, 4, 5, 2, 3)).depth() == 5
    Perm((1, 0, 4, 5, 3, 2)).depth() == 5
    Perm((1, 0, 5, 2, 3, 4)).depth() == 4
    Perm((1, 0, 5, 2, 4, 3)).depth() == 4
    Perm((1, 0, 5, 3, 2, 4)).depth() == 4
    Perm((1, 0, 5, 3, 4, 2)).depth() == 4
    Perm((1, 0, 5, 4, 2, 3)).depth() == 5
    Perm((1, 0, 5, 4, 3, 2)).depth() == 5
    Perm((1, 2, 0, 3, 4, 5)).depth() == 2
    Perm((1, 2, 0, 3, 5, 4)).depth() == 3
    Perm((1, 2, 0, 4, 3, 5)).depth() == 3
    Perm((1, 2, 0, 4, 5, 3)).depth() == 4
    Perm((1, 2, 0, 5, 3, 4)).depth() == 4
    Perm((1, 2, 0, 5, 4, 3)).depth() == 4
    Perm((1, 2, 3, 0, 4, 5)).depth() == 3
    Perm((1, 2, 3, 0, 5, 4)).depth() == 4
    Perm((1, 2, 3, 4, 0, 5)).depth() == 4
    Perm((1, 2, 3, 4, 5, 0)).depth() == 5
    Perm((1, 2, 3, 5, 0, 4)).depth() == 5
    Perm((1, 2, 3, 5, 4, 0)).depth() == 5
    Perm((1, 2, 4, 0, 3, 5)).depth() == 4
    Perm((1, 2, 4, 0, 5, 3)).depth() == 5
    Perm((1, 2, 4, 3, 0, 5)).depth() == 4
    Perm((1, 2, 4, 3, 5, 0)).depth() == 5
    Perm((1, 2, 4, 5, 0, 3)).depth() == 6
    Perm((1, 2, 4, 5, 3, 0)).depth() == 6
    Perm((1, 2, 5, 0, 3, 4)).depth() == 5
    Perm((1, 2, 5, 0, 4, 3)).depth() == 5
    Perm((1, 2, 5, 3, 0, 4)).depth() == 5
    Perm((1, 2, 5, 3, 4, 0)).depth() == 5
    Perm((1, 2, 5, 4, 0, 3)).depth() == 6
    Perm((1, 2, 5, 4, 3, 0)).depth() == 6
    Perm((1, 3, 0, 2, 4, 5)).depth() == 3
    Perm((1, 3, 0, 2, 5, 4)).depth() == 4
    Perm((1, 3, 0, 4, 2, 5)).depth() == 4
    Perm((1, 3, 0, 4, 5, 2)).depth() == 5
    Perm((1, 3, 0, 5, 2, 4)).depth() == 5
    Perm((1, 3, 0, 5, 4, 2)).depth() == 5
    Perm((1, 3, 2, 0, 4, 5)).depth() == 3
    Perm((1, 3, 2, 0, 5, 4)).depth() == 4
    Perm((1, 3, 2, 4, 0, 5)).depth() == 4
    Perm((1, 3, 2, 4, 5, 0)).depth() == 5
    Perm((1, 3, 2, 5, 0, 4)).depth() == 5
    Perm((1, 3, 2, 5, 4, 0)).depth() == 5
    Perm((1, 3, 4, 0, 2, 5)).depth() == 5
    Perm((1, 3, 4, 0, 5, 2)).depth() == 6
    Perm((1, 3, 4, 2, 0, 5)).depth() == 5
    Perm((1, 3, 4, 2, 5, 0)).depth() == 6
    Perm((1, 3, 4, 5, 0, 2)).depth() == 7
    Perm((1, 3, 4, 5, 2, 0)).depth() == 7
    Perm((1, 3, 5, 0, 2, 4)).depth() == 6
    Perm((1, 3, 5, 0, 4, 2)).depth() == 6
    Perm((1, 3, 5, 2, 0, 4)).depth() == 6
    Perm((1, 3, 5, 2, 4, 0)).depth() == 6
    Perm((1, 3, 5, 4, 0, 2)).depth() == 7
    Perm((1, 3, 5, 4, 2, 0)).depth() == 7
    Perm((1, 4, 0, 2, 3, 5)).depth() == 4
    Perm((1, 4, 0, 2, 5, 3)).depth() == 5
    Perm((1, 4, 0, 3, 2, 5)).depth() == 4
    Perm((1, 4, 0, 3, 5, 2)).depth() == 5
    Perm((1, 4, 0, 5, 2, 3)).depth() == 6
    Perm((1, 4, 0, 5, 3, 2)).depth() == 6
    Perm((1, 4, 2, 0, 3, 5)).depth() == 4
    Perm((1, 4, 2, 0, 5, 3)).depth() == 5
    Perm((1, 4, 2, 3, 0, 5)).depth() == 4
    Perm((1, 4, 2, 3, 5, 0)).depth() == 5
    Perm((1, 4, 2, 5, 0, 3)).depth() == 6
    Perm((1, 4, 2, 5, 3, 0)).depth() == 6
    Perm((1, 4, 3, 0, 2, 5)).depth() == 5
    Perm((1, 4, 3, 0, 5, 2)).depth() == 6
    Perm((1, 4, 3, 2, 0, 5)).depth() == 5
    Perm((1, 4, 3, 2, 5, 0)).depth() == 6
    Perm((1, 4, 3, 5, 0, 2)).depth() == 7
    Perm((1, 4, 3, 5, 2, 0)).depth() == 7
    Perm((1, 4, 5, 0, 2, 3)).depth() == 7
    Perm((1, 4, 5, 0, 3, 2)).depth() == 7
    Perm((1, 4, 5, 2, 0, 3)).depth() == 7
    Perm((1, 4, 5, 2, 3, 0)).depth() == 7
    Perm((1, 4, 5, 3, 0, 2)).depth() == 7
    Perm((1, 4, 5, 3, 2, 0)).depth() == 7
    Perm((1, 5, 0, 2, 3, 4)).depth() == 5
    Perm((1, 5, 0, 2, 4, 3)).depth() == 5
    Perm((1, 5, 0, 3, 2, 4)).depth() == 5
    Perm((1, 5, 0, 3, 4, 2)).depth() == 5
    Perm((1, 5, 0, 4, 2, 3)).depth() == 6
    Perm((1, 5, 0, 4, 3, 2)).depth() == 6
    Perm((1, 5, 2, 0, 3, 4)).depth() == 5
    Perm((1, 5, 2, 0, 4, 3)).depth() == 5
    Perm((1, 5, 2, 3, 0, 4)).depth() == 5
    Perm((1, 5, 2, 3, 4, 0)).depth() == 5
    Perm((1, 5, 2, 4, 0, 3)).depth() == 6
    Perm((1, 5, 2, 4, 3, 0)).depth() == 6
    Perm((1, 5, 3, 0, 2, 4)).depth() == 6
    Perm((1, 5, 3, 0, 4, 2)).depth() == 6
    Perm((1, 5, 3, 2, 0, 4)).depth() == 6
    Perm((1, 5, 3, 2, 4, 0)).depth() == 6
    Perm((1, 5, 3, 4, 0, 2)).depth() == 7
    Perm((1, 5, 3, 4, 2, 0)).depth() == 7
    Perm((1, 5, 4, 0, 2, 3)).depth() == 7
    Perm((1, 5, 4, 0, 3, 2)).depth() == 7
    Perm((1, 5, 4, 2, 0, 3)).depth() == 7
    Perm((1, 5, 4, 2, 3, 0)).depth() == 7
    Perm((1, 5, 4, 3, 0, 2)).depth() == 7
    Perm((1, 5, 4, 3, 2, 0)).depth() == 7
    Perm((2, 0, 1, 3, 4, 5)).depth() == 2
    Perm((2, 0, 1, 3, 5, 4)).depth() == 3
    Perm((2, 0, 1, 4, 3, 5)).depth() == 3
    Perm((2, 0, 1, 4, 5, 3)).depth() == 4
    Perm((2, 0, 1, 5, 3, 4)).depth() == 4
    Perm((2, 0, 1, 5, 4, 3)).depth() == 4
    Perm((2, 0, 3, 1, 4, 5)).depth() == 3
    Perm((2, 0, 3, 1, 5, 4)).depth() == 4
    Perm((2, 0, 3, 4, 1, 5)).depth() == 4
    Perm((2, 0, 3, 4, 5, 1)).depth() == 5
    Perm((2, 0, 3, 5, 1, 4)).depth() == 5
    Perm((2, 0, 3, 5, 4, 1)).depth() == 5
    Perm((2, 0, 4, 1, 3, 5)).depth() == 4
    Perm((2, 0, 4, 1, 5, 3)).depth() == 5
    Perm((2, 0, 4, 3, 1, 5)).depth() == 4
    Perm((2, 0, 4, 3, 5, 1)).depth() == 5
    Perm((2, 0, 4, 5, 1, 3)).depth() == 6
    Perm((2, 0, 4, 5, 3, 1)).depth() == 6
    Perm((2, 0, 5, 1, 3, 4)).depth() == 5
    Perm((2, 0, 5, 1, 4, 3)).depth() == 5
    Perm((2, 0, 5, 3, 1, 4)).depth() == 5
    Perm((2, 0, 5, 3, 4, 1)).depth() == 5
    Perm((2, 0, 5, 4, 1, 3)).depth() == 6
    Perm((2, 0, 5, 4, 3, 1)).depth() == 6
    Perm((2, 1, 0, 3, 4, 5)).depth() == 2
    Perm((2, 1, 0, 3, 5, 4)).depth() == 3
    Perm((2, 1, 0, 4, 3, 5)).depth() == 3
    Perm((2, 1, 0, 4, 5, 3)).depth() == 4
    Perm((2, 1, 0, 5, 3, 4)).depth() == 4
    Perm((2, 1, 0, 5, 4, 3)).depth() == 4
    Perm((2, 1, 3, 0, 4, 5)).depth() == 3
    Perm((2, 1, 3, 0, 5, 4)).depth() == 4
    Perm((2, 1, 3, 4, 0, 5)).depth() == 4
    Perm((2, 1, 3, 4, 5, 0)).depth() == 5
    Perm((2, 1, 3, 5, 0, 4)).depth() == 5
    Perm((2, 1, 3, 5, 4, 0)).depth() == 5
    Perm((2, 1, 4, 0, 3, 5)).depth() == 4
    Perm((2, 1, 4, 0, 5, 3)).depth() == 5
    Perm((2, 1, 4, 3, 0, 5)).depth() == 4
    Perm((2, 1, 4, 3, 5, 0)).depth() == 5
    Perm((2, 1, 4, 5, 0, 3)).depth() == 6
    Perm((2, 1, 4, 5, 3, 0)).depth() == 6
    Perm((2, 1, 5, 0, 3, 4)).depth() == 5
    Perm((2, 1, 5, 0, 4, 3)).depth() == 5
    Perm((2, 1, 5, 3, 0, 4)).depth() == 5
    Perm((2, 1, 5, 3, 4, 0)).depth() == 5
    Perm((2, 1, 5, 4, 0, 3)).depth() == 6
    Perm((2, 1, 5, 4, 3, 0)).depth() == 6
    Perm((2, 3, 0, 1, 4, 5)).depth() == 4
    Perm((2, 3, 0, 1, 5, 4)).depth() == 5
    Perm((2, 3, 0, 4, 1, 5)).depth() == 5
    Perm((2, 3, 0, 4, 5, 1)).depth() == 6
    Perm((2, 3, 0, 5, 1, 4)).depth() == 6
    Perm((2, 3, 0, 5, 4, 1)).depth() == 6
    Perm((2, 3, 1, 0, 4, 5)).depth() == 4
    Perm((2, 3, 1, 0, 5, 4)).depth() == 5
    Perm((2, 3, 1, 4, 0, 5)).depth() == 5
    Perm((2, 3, 1, 4, 5, 0)).depth() == 6
    Perm((2, 3, 1, 5, 0, 4)).depth() == 6
    Perm((2, 3, 1, 5, 4, 0)).depth() == 6
    Perm((2, 3, 4, 0, 1, 5)).depth() == 6
    Perm((2, 3, 4, 0, 5, 1)).depth() == 7
    Perm((2, 3, 4, 1, 0, 5)).depth() == 6
    Perm((2, 3, 4, 1, 5, 0)).depth() == 7
    Perm((2, 3, 4, 5, 0, 1)).depth() == 8
    Perm((2, 3, 4, 5, 1, 0)).depth() == 8
    Perm((2, 3, 5, 0, 1, 4)).depth() == 7
    Perm((2, 3, 5, 0, 4, 1)).depth() == 7
    Perm((2, 3, 5, 1, 0, 4)).depth() == 7
    Perm((2, 3, 5, 1, 4, 0)).depth() == 7
    Perm((2, 3, 5, 4, 0, 1)).depth() == 8
    Perm((2, 3, 5, 4, 1, 0)).depth() == 8
    Perm((2, 4, 0, 1, 3, 5)).depth() == 5
    Perm((2, 4, 0, 1, 5, 3)).depth() == 6
    Perm((2, 4, 0, 3, 1, 5)).depth() == 5
    Perm((2, 4, 0, 3, 5, 1)).depth() == 6
    Perm((2, 4, 0, 5, 1, 3)).depth() == 7
    Perm((2, 4, 0, 5, 3, 1)).depth() == 7
    Perm((2, 4, 1, 0, 3, 5)).depth() == 5
    Perm((2, 4, 1, 0, 5, 3)).depth() == 6
    Perm((2, 4, 1, 3, 0, 5)).depth() == 5
    Perm((2, 4, 1, 3, 5, 0)).depth() == 6
    Perm((2, 4, 1, 5, 0, 3)).depth() == 7
    Perm((2, 4, 1, 5, 3, 0)).depth() == 7
    Perm((2, 4, 3, 0, 1, 5)).depth() == 6
    Perm((2, 4, 3, 0, 5, 1)).depth() == 7
    Perm((2, 4, 3, 1, 0, 5)).depth() == 6
    Perm((2, 4, 3, 1, 5, 0)).depth() == 7
    Perm((2, 4, 3, 5, 0, 1)).depth() == 8
    Perm((2, 4, 3, 5, 1, 0)).depth() == 8
    Perm((2, 4, 5, 0, 1, 3)).depth() == 8
    Perm((2, 4, 5, 0, 3, 1)).depth() == 8
    Perm((2, 4, 5, 1, 0, 3)).depth() == 8
    Perm((2, 4, 5, 1, 3, 0)).depth() == 8
    Perm((2, 4, 5, 3, 0, 1)).depth() == 8
    Perm((2, 4, 5, 3, 1, 0)).depth() == 8
    Perm((2, 5, 0, 1, 3, 4)).depth() == 6
    Perm((2, 5, 0, 1, 4, 3)).depth() == 6
    Perm((2, 5, 0, 3, 1, 4)).depth() == 6
    Perm((2, 5, 0, 3, 4, 1)).depth() == 6
    Perm((2, 5, 0, 4, 1, 3)).depth() == 7
    Perm((2, 5, 0, 4, 3, 1)).depth() == 7
    Perm((2, 5, 1, 0, 3, 4)).depth() == 6
    Perm((2, 5, 1, 0, 4, 3)).depth() == 6
    Perm((2, 5, 1, 3, 0, 4)).depth() == 6
    Perm((2, 5, 1, 3, 4, 0)).depth() == 6
    Perm((2, 5, 1, 4, 0, 3)).depth() == 7
    Perm((2, 5, 1, 4, 3, 0)).depth() == 7
    Perm((2, 5, 3, 0, 1, 4)).depth() == 7
    Perm((2, 5, 3, 0, 4, 1)).depth() == 7
    Perm((2, 5, 3, 1, 0, 4)).depth() == 7
    Perm((2, 5, 3, 1, 4, 0)).depth() == 7
    Perm((2, 5, 3, 4, 0, 1)).depth() == 8
    Perm((2, 5, 3, 4, 1, 0)).depth() == 8
    Perm((2, 5, 4, 0, 1, 3)).depth() == 8
    Perm((2, 5, 4, 0, 3, 1)).depth() == 8
    Perm((2, 5, 4, 1, 0, 3)).depth() == 8
    Perm((2, 5, 4, 1, 3, 0)).depth() == 8
    Perm((2, 5, 4, 3, 0, 1)).depth() == 8
    Perm((2, 5, 4, 3, 1, 0)).depth() == 8
    Perm((3, 0, 1, 2, 4, 5)).depth() == 3
    Perm((3, 0, 1, 2, 5, 4)).depth() == 4
    Perm((3, 0, 1, 4, 2, 5)).depth() == 4
    Perm((3, 0, 1, 4, 5, 2)).depth() == 5
    Perm((3, 0, 1, 5, 2, 4)).depth() == 5
    Perm((3, 0, 1, 5, 4, 2)).depth() == 5
    Perm((3, 0, 2, 1, 4, 5)).depth() == 3
    Perm((3, 0, 2, 1, 5, 4)).depth() == 4
    Perm((3, 0, 2, 4, 1, 5)).depth() == 4
    Perm((3, 0, 2, 4, 5, 1)).depth() == 5
    Perm((3, 0, 2, 5, 1, 4)).depth() == 5
    Perm((3, 0, 2, 5, 4, 1)).depth() == 5
    Perm((3, 0, 4, 1, 2, 5)).depth() == 5
    Perm((3, 0, 4, 1, 5, 2)).depth() == 6
    Perm((3, 0, 4, 2, 1, 5)).depth() == 5
    Perm((3, 0, 4, 2, 5, 1)).depth() == 6
    Perm((3, 0, 4, 5, 1, 2)).depth() == 7
    Perm((3, 0, 4, 5, 2, 1)).depth() == 7
    Perm((3, 0, 5, 1, 2, 4)).depth() == 6
    Perm((3, 0, 5, 1, 4, 2)).depth() == 6
    Perm((3, 0, 5, 2, 1, 4)).depth() == 6
    Perm((3, 0, 5, 2, 4, 1)).depth() == 6
    Perm((3, 0, 5, 4, 1, 2)).depth() == 7
    Perm((3, 0, 5, 4, 2, 1)).depth() == 7
    Perm((3, 1, 0, 2, 4, 5)).depth() == 3
    Perm((3, 1, 0, 2, 5, 4)).depth() == 4
    Perm((3, 1, 0, 4, 2, 5)).depth() == 4
    Perm((3, 1, 0, 4, 5, 2)).depth() == 5
    Perm((3, 1, 0, 5, 2, 4)).depth() == 5
    Perm((3, 1, 0, 5, 4, 2)).depth() == 5
    Perm((3, 1, 2, 0, 4, 5)).depth() == 3
    Perm((3, 1, 2, 0, 5, 4)).depth() == 4
    Perm((3, 1, 2, 4, 0, 5)).depth() == 4
    Perm((3, 1, 2, 4, 5, 0)).depth() == 5
    Perm((3, 1, 2, 5, 0, 4)).depth() == 5
    Perm((3, 1, 2, 5, 4, 0)).depth() == 5
    Perm((3, 1, 4, 0, 2, 5)).depth() == 5
    Perm((3, 1, 4, 0, 5, 2)).depth() == 6
    Perm((3, 1, 4, 2, 0, 5)).depth() == 5
    Perm((3, 1, 4, 2, 5, 0)).depth() == 6
    Perm((3, 1, 4, 5, 0, 2)).depth() == 7
    Perm((3, 1, 4, 5, 2, 0)).depth() == 7
    Perm((3, 1, 5, 0, 2, 4)).depth() == 6
    Perm((3, 1, 5, 0, 4, 2)).depth() == 6
    Perm((3, 1, 5, 2, 0, 4)).depth() == 6
    Perm((3, 1, 5, 2, 4, 0)).depth() == 6
    Perm((3, 1, 5, 4, 0, 2)).depth() == 7
    Perm((3, 1, 5, 4, 2, 0)).depth() == 7
    Perm((3, 2, 0, 1, 4, 5)).depth() == 4
    Perm((3, 2, 0, 1, 5, 4)).depth() == 5
    Perm((3, 2, 0, 4, 1, 5)).depth() == 5
    Perm((3, 2, 0, 4, 5, 1)).depth() == 6
    Perm((3, 2, 0, 5, 1, 4)).depth() == 6
    Perm((3, 2, 0, 5, 4, 1)).depth() == 6
    Perm((3, 2, 1, 0, 4, 5)).depth() == 4
    Perm((3, 2, 1, 0, 5, 4)).depth() == 5
    Perm((3, 2, 1, 4, 0, 5)).depth() == 5
    Perm((3, 2, 1, 4, 5, 0)).depth() == 6
    Perm((3, 2, 1, 5, 0, 4)).depth() == 6
    Perm((3, 2, 1, 5, 4, 0)).depth() == 6
    Perm((3, 2, 4, 0, 1, 5)).depth() == 6
    Perm((3, 2, 4, 0, 5, 1)).depth() == 7
    Perm((3, 2, 4, 1, 0, 5)).depth() == 6
    Perm((3, 2, 4, 1, 5, 0)).depth() == 7
    Perm((3, 2, 4, 5, 0, 1)).depth() == 8
    Perm((3, 2, 4, 5, 1, 0)).depth() == 8
    Perm((3, 2, 5, 0, 1, 4)).depth() == 7
    Perm((3, 2, 5, 0, 4, 1)).depth() == 7
    Perm((3, 2, 5, 1, 0, 4)).depth() == 7
    Perm((3, 2, 5, 1, 4, 0)).depth() == 7
    Perm((3, 2, 5, 4, 0, 1)).depth() == 8
    Perm((3, 2, 5, 4, 1, 0)).depth() == 8
    Perm((3, 4, 0, 1, 2, 5)).depth() == 6
    Perm((3, 4, 0, 1, 5, 2)).depth() == 7
    Perm((3, 4, 0, 2, 1, 5)).depth() == 6
    Perm((3, 4, 0, 2, 5, 1)).depth() == 7
    Perm((3, 4, 0, 5, 1, 2)).depth() == 8
    Perm((3, 4, 0, 5, 2, 1)).depth() == 8
    Perm((3, 4, 1, 0, 2, 5)).depth() == 6
    Perm((3, 4, 1, 0, 5, 2)).depth() == 7
    Perm((3, 4, 1, 2, 0, 5)).depth() == 6
    Perm((3, 4, 1, 2, 5, 0)).depth() == 7
    Perm((3, 4, 1, 5, 0, 2)).depth() == 8
    Perm((3, 4, 1, 5, 2, 0)).depth() == 8
    Perm((3, 4, 2, 0, 1, 5)).depth() == 6
    Perm((3, 4, 2, 0, 5, 1)).depth() == 7
    Perm((3, 4, 2, 1, 0, 5)).depth() == 6
    Perm((3, 4, 2, 1, 5, 0)).depth() == 7
    Perm((3, 4, 2, 5, 0, 1)).depth() == 8
    Perm((3, 4, 2, 5, 1, 0)).depth() == 8
    Perm((3, 4, 5, 0, 1, 2)).depth() == 9
    Perm((3, 4, 5, 0, 2, 1)).depth() == 9
    Perm((3, 4, 5, 1, 0, 2)).depth() == 9
    Perm((3, 4, 5, 1, 2, 0)).depth() == 9
    Perm((3, 4, 5, 2, 0, 1)).depth() == 9
    Perm((3, 4, 5, 2, 1, 0)).depth() == 9
    Perm((3, 5, 0, 1, 2, 4)).depth() == 7
    Perm((3, 5, 0, 1, 4, 2)).depth() == 7
    Perm((3, 5, 0, 2, 1, 4)).depth() == 7
    Perm((3, 5, 0, 2, 4, 1)).depth() == 7
    Perm((3, 5, 0, 4, 1, 2)).depth() == 8
    Perm((3, 5, 0, 4, 2, 1)).depth() == 8
    Perm((3, 5, 1, 0, 2, 4)).depth() == 7
    Perm((3, 5, 1, 0, 4, 2)).depth() == 7
    Perm((3, 5, 1, 2, 0, 4)).depth() == 7
    Perm((3, 5, 1, 2, 4, 0)).depth() == 7
    Perm((3, 5, 1, 4, 0, 2)).depth() == 8
    Perm((3, 5, 1, 4, 2, 0)).depth() == 8
    Perm((3, 5, 2, 0, 1, 4)).depth() == 7
    Perm((3, 5, 2, 0, 4, 1)).depth() == 7
    Perm((3, 5, 2, 1, 0, 4)).depth() == 7
    Perm((3, 5, 2, 1, 4, 0)).depth() == 7
    Perm((3, 5, 2, 4, 0, 1)).depth() == 8
    Perm((3, 5, 2, 4, 1, 0)).depth() == 8
    Perm((3, 5, 4, 0, 1, 2)).depth() == 9
    Perm((3, 5, 4, 0, 2, 1)).depth() == 9
    Perm((3, 5, 4, 1, 0, 2)).depth() == 9
    Perm((3, 5, 4, 1, 2, 0)).depth() == 9
    Perm((3, 5, 4, 2, 0, 1)).depth() == 9
    Perm((3, 5, 4, 2, 1, 0)).depth() == 9
    Perm((4, 0, 1, 2, 3, 5)).depth() == 4
    Perm((4, 0, 1, 2, 5, 3)).depth() == 5
    Perm((4, 0, 1, 3, 2, 5)).depth() == 4
    Perm((4, 0, 1, 3, 5, 2)).depth() == 5
    Perm((4, 0, 1, 5, 2, 3)).depth() == 6
    Perm((4, 0, 1, 5, 3, 2)).depth() == 6
    Perm((4, 0, 2, 1, 3, 5)).depth() == 4
    Perm((4, 0, 2, 1, 5, 3)).depth() == 5
    Perm((4, 0, 2, 3, 1, 5)).depth() == 4
    Perm((4, 0, 2, 3, 5, 1)).depth() == 5
    Perm((4, 0, 2, 5, 1, 3)).depth() == 6
    Perm((4, 0, 2, 5, 3, 1)).depth() == 6
    Perm((4, 0, 3, 1, 2, 5)).depth() == 5
    Perm((4, 0, 3, 1, 5, 2)).depth() == 6
    Perm((4, 0, 3, 2, 1, 5)).depth() == 5
    Perm((4, 0, 3, 2, 5, 1)).depth() == 6
    Perm((4, 0, 3, 5, 1, 2)).depth() == 7
    Perm((4, 0, 3, 5, 2, 1)).depth() == 7
    Perm((4, 0, 5, 1, 2, 3)).depth() == 7
    Perm((4, 0, 5, 1, 3, 2)).depth() == 7
    Perm((4, 0, 5, 2, 1, 3)).depth() == 7
    Perm((4, 0, 5, 2, 3, 1)).depth() == 7
    Perm((4, 0, 5, 3, 1, 2)).depth() == 7
    Perm((4, 0, 5, 3, 2, 1)).depth() == 7
    Perm((4, 1, 0, 2, 3, 5)).depth() == 4
    Perm((4, 1, 0, 2, 5, 3)).depth() == 5
    Perm((4, 1, 0, 3, 2, 5)).depth() == 4
    Perm((4, 1, 0, 3, 5, 2)).depth() == 5
    Perm((4, 1, 0, 5, 2, 3)).depth() == 6
    Perm((4, 1, 0, 5, 3, 2)).depth() == 6
    Perm((4, 1, 2, 0, 3, 5)).depth() == 4
    Perm((4, 1, 2, 0, 5, 3)).depth() == 5
    Perm((4, 1, 2, 3, 0, 5)).depth() == 4
    Perm((4, 1, 2, 3, 5, 0)).depth() == 5
    Perm((4, 1, 2, 5, 0, 3)).depth() == 6
    Perm((4, 1, 2, 5, 3, 0)).depth() == 6
    Perm((4, 1, 3, 0, 2, 5)).depth() == 5
    Perm((4, 1, 3, 0, 5, 2)).depth() == 6
    Perm((4, 1, 3, 2, 0, 5)).depth() == 5
    Perm((4, 1, 3, 2, 5, 0)).depth() == 6
    Perm((4, 1, 3, 5, 0, 2)).depth() == 7
    Perm((4, 1, 3, 5, 2, 0)).depth() == 7
    Perm((4, 1, 5, 0, 2, 3)).depth() == 7
    Perm((4, 1, 5, 0, 3, 2)).depth() == 7
    Perm((4, 1, 5, 2, 0, 3)).depth() == 7
    Perm((4, 1, 5, 2, 3, 0)).depth() == 7
    Perm((4, 1, 5, 3, 0, 2)).depth() == 7
    Perm((4, 1, 5, 3, 2, 0)).depth() == 7
    Perm((4, 2, 0, 1, 3, 5)).depth() == 5
    Perm((4, 2, 0, 1, 5, 3)).depth() == 6
    Perm((4, 2, 0, 3, 1, 5)).depth() == 5
    Perm((4, 2, 0, 3, 5, 1)).depth() == 6
    Perm((4, 2, 0, 5, 1, 3)).depth() == 7
    Perm((4, 2, 0, 5, 3, 1)).depth() == 7
    Perm((4, 2, 1, 0, 3, 5)).depth() == 5
    Perm((4, 2, 1, 0, 5, 3)).depth() == 6
    Perm((4, 2, 1, 3, 0, 5)).depth() == 5
    Perm((4, 2, 1, 3, 5, 0)).depth() == 6
    Perm((4, 2, 1, 5, 0, 3)).depth() == 7
    Perm((4, 2, 1, 5, 3, 0)).depth() == 7
    Perm((4, 2, 3, 0, 1, 5)).depth() == 6
    Perm((4, 2, 3, 0, 5, 1)).depth() == 7
    Perm((4, 2, 3, 1, 0, 5)).depth() == 6
    Perm((4, 2, 3, 1, 5, 0)).depth() == 7
    Perm((4, 2, 3, 5, 0, 1)).depth() == 8
    Perm((4, 2, 3, 5, 1, 0)).depth() == 8
    Perm((4, 2, 5, 0, 1, 3)).depth() == 8
    Perm((4, 2, 5, 0, 3, 1)).depth() == 8
    Perm((4, 2, 5, 1, 0, 3)).depth() == 8
    Perm((4, 2, 5, 1, 3, 0)).depth() == 8
    Perm((4, 2, 5, 3, 0, 1)).depth() == 8
    Perm((4, 2, 5, 3, 1, 0)).depth() == 8
    Perm((4, 3, 0, 1, 2, 5)).depth() == 6
    Perm((4, 3, 0, 1, 5, 2)).depth() == 7
    Perm((4, 3, 0, 2, 1, 5)).depth() == 6
    Perm((4, 3, 0, 2, 5, 1)).depth() == 7
    Perm((4, 3, 0, 5, 1, 2)).depth() == 8
    Perm((4, 3, 0, 5, 2, 1)).depth() == 8
    Perm((4, 3, 1, 0, 2, 5)).depth() == 6
    Perm((4, 3, 1, 0, 5, 2)).depth() == 7
    Perm((4, 3, 1, 2, 0, 5)).depth() == 6
    Perm((4, 3, 1, 2, 5, 0)).depth() == 7
    Perm((4, 3, 1, 5, 0, 2)).depth() == 8
    Perm((4, 3, 1, 5, 2, 0)).depth() == 8
    Perm((4, 3, 2, 0, 1, 5)).depth() == 6
    Perm((4, 3, 2, 0, 5, 1)).depth() == 7
    Perm((4, 3, 2, 1, 0, 5)).depth() == 6
    Perm((4, 3, 2, 1, 5, 0)).depth() == 7
    Perm((4, 3, 2, 5, 0, 1)).depth() == 8
    Perm((4, 3, 2, 5, 1, 0)).depth() == 8
    Perm((4, 3, 5, 0, 1, 2)).depth() == 9
    Perm((4, 3, 5, 0, 2, 1)).depth() == 9
    Perm((4, 3, 5, 1, 0, 2)).depth() == 9
    Perm((4, 3, 5, 1, 2, 0)).depth() == 9
    Perm((4, 3, 5, 2, 0, 1)).depth() == 9
    Perm((4, 3, 5, 2, 1, 0)).depth() == 9
    Perm((4, 5, 0, 1, 2, 3)).depth() == 8
    Perm((4, 5, 0, 1, 3, 2)).depth() == 8
    Perm((4, 5, 0, 2, 1, 3)).depth() == 8
    Perm((4, 5, 0, 2, 3, 1)).depth() == 8
    Perm((4, 5, 0, 3, 1, 2)).depth() == 8
    Perm((4, 5, 0, 3, 2, 1)).depth() == 8
    Perm((4, 5, 1, 0, 2, 3)).depth() == 8
    Perm((4, 5, 1, 0, 3, 2)).depth() == 8
    Perm((4, 5, 1, 2, 0, 3)).depth() == 8
    Perm((4, 5, 1, 2, 3, 0)).depth() == 8
    Perm((4, 5, 1, 3, 0, 2)).depth() == 8
    Perm((4, 5, 1, 3, 2, 0)).depth() == 8
    Perm((4, 5, 2, 0, 1, 3)).depth() == 8
    Perm((4, 5, 2, 0, 3, 1)).depth() == 8
    Perm((4, 5, 2, 1, 0, 3)).depth() == 8
    Perm((4, 5, 2, 1, 3, 0)).depth() == 8
    Perm((4, 5, 2, 3, 0, 1)).depth() == 8
    Perm((4, 5, 2, 3, 1, 0)).depth() == 8
    Perm((4, 5, 3, 0, 1, 2)).depth() == 9
    Perm((4, 5, 3, 0, 2, 1)).depth() == 9
    Perm((4, 5, 3, 1, 0, 2)).depth() == 9
    Perm((4, 5, 3, 1, 2, 0)).depth() == 9
    Perm((4, 5, 3, 2, 0, 1)).depth() == 9
    Perm((4, 5, 3, 2, 1, 0)).depth() == 9
    Perm((5, 0, 1, 2, 3, 4)).depth() == 5
    Perm((5, 0, 1, 2, 4, 3)).depth() == 5
    Perm((5, 0, 1, 3, 2, 4)).depth() == 5
    Perm((5, 0, 1, 3, 4, 2)).depth() == 5
    Perm((5, 0, 1, 4, 2, 3)).depth() == 6
    Perm((5, 0, 1, 4, 3, 2)).depth() == 6
    Perm((5, 0, 2, 1, 3, 4)).depth() == 5
    Perm((5, 0, 2, 1, 4, 3)).depth() == 5
    Perm((5, 0, 2, 3, 1, 4)).depth() == 5
    Perm((5, 0, 2, 3, 4, 1)).depth() == 5
    Perm((5, 0, 2, 4, 1, 3)).depth() == 6
    Perm((5, 0, 2, 4, 3, 1)).depth() == 6
    Perm((5, 0, 3, 1, 2, 4)).depth() == 6
    Perm((5, 0, 3, 1, 4, 2)).depth() == 6
    Perm((5, 0, 3, 2, 1, 4)).depth() == 6
    Perm((5, 0, 3, 2, 4, 1)).depth() == 6
    Perm((5, 0, 3, 4, 1, 2)).depth() == 7
    Perm((5, 0, 3, 4, 2, 1)).depth() == 7
    Perm((5, 0, 4, 1, 2, 3)).depth() == 7
    Perm((5, 0, 4, 1, 3, 2)).depth() == 7
    Perm((5, 0, 4, 2, 1, 3)).depth() == 7
    Perm((5, 0, 4, 2, 3, 1)).depth() == 7
    Perm((5, 0, 4, 3, 1, 2)).depth() == 7
    Perm((5, 0, 4, 3, 2, 1)).depth() == 7
    Perm((5, 1, 0, 2, 3, 4)).depth() == 5
    Perm((5, 1, 0, 2, 4, 3)).depth() == 5
    Perm((5, 1, 0, 3, 2, 4)).depth() == 5
    Perm((5, 1, 0, 3, 4, 2)).depth() == 5
    Perm((5, 1, 0, 4, 2, 3)).depth() == 6
    Perm((5, 1, 0, 4, 3, 2)).depth() == 6
    Perm((5, 1, 2, 0, 3, 4)).depth() == 5
    Perm((5, 1, 2, 0, 4, 3)).depth() == 5
    Perm((5, 1, 2, 3, 0, 4)).depth() == 5
    Perm((5, 1, 2, 3, 4, 0)).depth() == 5
    Perm((5, 1, 2, 4, 0, 3)).depth() == 6
    Perm((5, 1, 2, 4, 3, 0)).depth() == 6
    Perm((5, 1, 3, 0, 2, 4)).depth() == 6
    Perm((5, 1, 3, 0, 4, 2)).depth() == 6
    Perm((5, 1, 3, 2, 0, 4)).depth() == 6
    Perm((5, 1, 3, 2, 4, 0)).depth() == 6
    Perm((5, 1, 3, 4, 0, 2)).depth() == 7
    Perm((5, 1, 3, 4, 2, 0)).depth() == 7
    Perm((5, 1, 4, 0, 2, 3)).depth() == 7
    Perm((5, 1, 4, 0, 3, 2)).depth() == 7
    Perm((5, 1, 4, 2, 0, 3)).depth() == 7
    Perm((5, 1, 4, 2, 3, 0)).depth() == 7
    Perm((5, 1, 4, 3, 0, 2)).depth() == 7
    Perm((5, 1, 4, 3, 2, 0)).depth() == 7
    Perm((5, 2, 0, 1, 3, 4)).depth() == 6
    Perm((5, 2, 0, 1, 4, 3)).depth() == 6
    Perm((5, 2, 0, 3, 1, 4)).depth() == 6
    Perm((5, 2, 0, 3, 4, 1)).depth() == 6
    Perm((5, 2, 0, 4, 1, 3)).depth() == 7
    Perm((5, 2, 0, 4, 3, 1)).depth() == 7
    Perm((5, 2, 1, 0, 3, 4)).depth() == 6
    Perm((5, 2, 1, 0, 4, 3)).depth() == 6
    Perm((5, 2, 1, 3, 0, 4)).depth() == 6
    Perm((5, 2, 1, 3, 4, 0)).depth() == 6
    Perm((5, 2, 1, 4, 0, 3)).depth() == 7
    Perm((5, 2, 1, 4, 3, 0)).depth() == 7
    Perm((5, 2, 3, 0, 1, 4)).depth() == 7
    Perm((5, 2, 3, 0, 4, 1)).depth() == 7
    Perm((5, 2, 3, 1, 0, 4)).depth() == 7
    Perm((5, 2, 3, 1, 4, 0)).depth() == 7
    Perm((5, 2, 3, 4, 0, 1)).depth() == 8
    Perm((5, 2, 3, 4, 1, 0)).depth() == 8
    Perm((5, 2, 4, 0, 1, 3)).depth() == 8
    Perm((5, 2, 4, 0, 3, 1)).depth() == 8
    Perm((5, 2, 4, 1, 0, 3)).depth() == 8
    Perm((5, 2, 4, 1, 3, 0)).depth() == 8
    Perm((5, 2, 4, 3, 0, 1)).depth() == 8
    Perm((5, 2, 4, 3, 1, 0)).depth() == 8
    Perm((5, 3, 0, 1, 2, 4)).depth() == 7
    Perm((5, 3, 0, 1, 4, 2)).depth() == 7
    Perm((5, 3, 0, 2, 1, 4)).depth() == 7
    Perm((5, 3, 0, 2, 4, 1)).depth() == 7
    Perm((5, 3, 0, 4, 1, 2)).depth() == 8
    Perm((5, 3, 0, 4, 2, 1)).depth() == 8
    Perm((5, 3, 1, 0, 2, 4)).depth() == 7
    Perm((5, 3, 1, 0, 4, 2)).depth() == 7
    Perm((5, 3, 1, 2, 0, 4)).depth() == 7
    Perm((5, 3, 1, 2, 4, 0)).depth() == 7
    Perm((5, 3, 1, 4, 0, 2)).depth() == 8
    Perm((5, 3, 1, 4, 2, 0)).depth() == 8
    Perm((5, 3, 2, 0, 1, 4)).depth() == 7
    Perm((5, 3, 2, 0, 4, 1)).depth() == 7
    Perm((5, 3, 2, 1, 0, 4)).depth() == 7
    Perm((5, 3, 2, 1, 4, 0)).depth() == 7
    Perm((5, 3, 2, 4, 0, 1)).depth() == 8
    Perm((5, 3, 2, 4, 1, 0)).depth() == 8
    Perm((5, 3, 4, 0, 1, 2)).depth() == 9
    Perm((5, 3, 4, 0, 2, 1)).depth() == 9
    Perm((5, 3, 4, 1, 0, 2)).depth() == 9
    Perm((5, 3, 4, 1, 2, 0)).depth() == 9
    Perm((5, 3, 4, 2, 0, 1)).depth() == 9
    Perm((5, 3, 4, 2, 1, 0)).depth() == 9
    Perm((5, 4, 0, 1, 2, 3)).depth() == 8
    Perm((5, 4, 0, 1, 3, 2)).depth() == 8
    Perm((5, 4, 0, 2, 1, 3)).depth() == 8
    Perm((5, 4, 0, 2, 3, 1)).depth() == 8
    Perm((5, 4, 0, 3, 1, 2)).depth() == 8
    Perm((5, 4, 0, 3, 2, 1)).depth() == 8
    Perm((5, 4, 1, 0, 2, 3)).depth() == 8
    Perm((5, 4, 1, 0, 3, 2)).depth() == 8
    Perm((5, 4, 1, 2, 0, 3)).depth() == 8
    Perm((5, 4, 1, 2, 3, 0)).depth() == 8
    Perm((5, 4, 1, 3, 0, 2)).depth() == 8
    Perm((5, 4, 1, 3, 2, 0)).depth() == 8
    Perm((5, 4, 2, 0, 1, 3)).depth() == 8
    Perm((5, 4, 2, 0, 3, 1)).depth() == 8
    Perm((5, 4, 2, 1, 0, 3)).depth() == 8
    Perm((5, 4, 2, 1, 3, 0)).depth() == 8
    Perm((5, 4, 2, 3, 0, 1)).depth() == 8
    Perm((5, 4, 2, 3, 1, 0)).depth() == 8
    Perm((5, 4, 3, 0, 1, 2)).depth() == 9
    Perm((5, 4, 3, 0, 2, 1)).depth() == 9
    Perm((5, 4, 3, 1, 0, 2)).depth() == 9
    Perm((5, 4, 3, 1, 2, 0)).depth() == 9
    Perm((5, 4, 3, 2, 0, 1)).depth() == 9
    Perm((5, 4, 3, 2, 1, 0)).depth() == 9
